            ...
            for (int x = -(mapResolution/2); x < mapResolution/2; x++) {
                for (int y = -(mapResolution/2); y < mapResolution/2; y++) {
                    for (int z = -(mapResolution/2); z < mapResolution/2; z++) {
                        ...
                        xNoise = (float)ImprovedNoise.noise(ny*1.2f, nz*1.2f, seed)*20;
                        yNoise = (float)ImprovedNoise.noise(nx*1.2f, nz*1.2f, seed)*20;
                        zNoise = (float)ImprovedNoise.noise(nx*1.2f, ny*1.2f, seed)*20;
